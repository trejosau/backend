...
import { inferAppKey, inferAppUrl } from '#utils/runtime_defaults'
 ...
 */
export const appKey = env.get('APP_KEY', inferAppKey())
 ...
 * use absolute URLs.
 */
export const appUrl = env.get('APP_URL', inferAppUrl())
